...
export default function FortuneCard({ data }: { data: AIResult }) {
    ...
    return (
        ...
        >
            <ShineBorder className="w-full rounded-2xl border border-white/10 overflow-hidden shadow-[0_0_50px_-12px_rgba(255,215,0,0.1)] bg-white/5 backdrop-blur-2xl" color={["#A07CFE", "#FE8FB5", "#FFBE7B"]}>
